...
MQTT \cite{mqtt5}, LTE (HSS, PDCP, MME, QCI), and TDL \cite{tdl} with \cite{link16std}, tailored for military
...
at a cost of approximately \$8,400, leveraging open-source srsRAN and COTS
