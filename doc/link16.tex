...
\begin{itemize}
    \item \textbf{Setup}: Server (\texttt{f16s}) and multiple clients (\texttt{f16c}) simulating JUs.
    \item \textbf{Results}:
        \begin{itemize}
