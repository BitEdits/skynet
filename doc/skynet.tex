...
configured via \texttt{skynet\_convergence\_init} and processed in
\texttt{skynet\_convergence\_process\_message}. QoS 0 skips \texttt{reorder\_queue} and ACKs, QoS 1
...
2 & 3  & 1   & QCI 5 & 50ms  & 3 & \texttt{KEY\_EXCHANGE, SLOT\_REQUEST, ACK} \\
2 & 2  & 100 & QCI 3 & 50ms  & 3 & \texttt{WAYPOINT, FORMATION, ACK} \\
